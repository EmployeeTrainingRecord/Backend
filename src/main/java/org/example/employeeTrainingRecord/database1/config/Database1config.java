package org.example.employeeTrainingRecord.database1.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "Database1EntityManagerFactory",
        ...
        basePackages = {"org.example.employeeTrainingRecord.database1.repositories"})
...
//            .url("jdbc:mysql://" + mysqlUrl + ":3306/employee_training_record")
//            .username(mysqlUser)
...
//}
    ...
    @Bean(name = "Database1DataSource")
    public DataSource Database1DataSource() {
        return DataSourceBuilder.create() .url("jdbc:mysql://localhost:3306/employee_training_record") .username("root") .password("mysql@sit") .driverClassName("com.mysql.cj.jdbc.Driver") .build();
    }
    ...
    public LocalContainerEntityManagerFactoryBean Database1EntityManagerFactory(
        ...
        return builder
                ...
                .packages("org.example.employeeTrainingRecord.database1.entities")
